...
plot_greater_region = False  # Switch to toggle Greater Region shapefile
if plot_greater_region:
    gdf = gpd.read_file(greater_region_path)
    gdf.to_crs(projection).plot(ax=ax, edgecolor='black', linestyle=':', linewidth=1.5, facecolor='none')
...
# Add gridlines with equal intervals
...
save_path = "/Users/haseeb.rehman/Desktop/For_Animation/3rd_Year/Miscs/domains_setup_map.png"
