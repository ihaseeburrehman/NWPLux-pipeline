...
MET_EM_FILES=$HOMEDIR/WPS-4.5/met_em_files_ERA5_2021_event
OBASCIIDIR=$HOMEDIR/WRFDA/DAT_DIR/concatenate_June_July_2021
B_MATRIX_DIR=$HOMEDIR/WRFDA/DAT_DIR/be/be_dat_cv5
