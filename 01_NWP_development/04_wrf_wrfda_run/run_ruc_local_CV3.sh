...
MET_EM_FILES=$HOMEDIR/WRFV4.5/run/met_em_files_2021_3_domains #met_em_files generted by WPS
...
MULTIPLE=4            # Define number of cycles for a RUC
...
MAX_DOM_FF=1                     #for final forecast run
PARENT_ID='1,1,2,3,'           # ID of parent domain
PARENT_GRID_RATIO='1,3,3,5'    # grid ratio between domains
I_PARENT_START='1,43,34,380' # X-coordinate of the lower left corner of each domain
J_PARENT_START='1,43,44,310'  # Y-coordinate of the lower left corner of each domain
